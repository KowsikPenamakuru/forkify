// The reason we used this is to make parcel import its dist version of the icons.svg into the code and render
...
class RecipeView extends View {
  ...
  _errorMessage = 'Unable to find recipe. Please try again!';
  _message = '';
